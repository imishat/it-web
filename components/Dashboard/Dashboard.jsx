  ...
  return (
    <div>
      ...
      <div class="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
        <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
          ...
          <div class="p-4 text-right">
            <p class="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">Todays Money</p>
        ...
        <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
          ...
          <div class="p-4 text-right">
            <p class="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">Todays Users</p>
      ...
      <div class="mb-4 grid grid-cols-1 gap-6 xl:grid-cols-3">
        <div class="relative flex flex-col bg-clip-border rounded-xl bg-base-200 text-gray-700 shadow-md overflow-hidden xl:col-span-2">
          <div class="relative bg-clip-border rounded-xl overflow-hidden bg-transparent text-gray-700 shadow-none m-0 flex items-center justify-between p-6">
            <div>
              <Link href={`/dashboard/products`} class="block link-hover antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-blue-gray-900 mb-1">Products</Link>
          ...
          {/* table */}
          <div class="p-6 overflow-x-auto px-0 flex justify-center w-full pt-0 pb-2">
            <table class="w-full min-w-[440px] table-auto">
              <thead>
                <tr>
                  ...
                  <td class="py-3 px-5 border-b border-blue-gray-50">
                    <div class="w-10/12">
                      ...
                      <div class="flex flex-start bg-blue-gray-50 overflow-hidden w-full rounded-sm font-sans text-xs font-medium h-1">
                        <div class="flex justify-center items-center w-[60%] h-full bg-gradient-to-tr from-blue-600 to-blue-400 text-white" ></div>
                      </div>
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="py-3 px-5 border-b border-blue-gray-50">
                    <div class="w-10/12">
                      ...
                      <div class="flex flex-start bg-blue-gray-50 overflow-hidden w-full rounded-sm font-sans text-xs font-medium h-1">
                        <div class="flex justify-center items-center w-[10%] h-full bg-gradient-to-tr from-blue-600 to-blue-400 text-white"></div>
                      </div>
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="py-3 px-5 border-b border-blue-gray-50">
                    <div class="w-10/12">
                      ...
                      <div class="flex flex-start bg-blue-gray-50 overflow-hidden w-full rounded-sm font-sans text-xs font-medium h-1">
                        <div class="flex justify-center items-center w-full h-full bg-gradient-to-tr from-green-600 to-green-400 text-white"></div>
                      </div>
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="py-3 px-5 border-b border-blue-gray-50">
                    <div class="w-10/12">
                      <p class="antialiased font-sans mb-1 block text-xs font-medium text-blue-gray-600">100%</p>
                      <div class="flex flex-start bg-blue-gray-50 overflow-hidden w-full rounded-sm font-sans text-xs font-medium h-1">
                        <div class="flex justify-center items-center h-full w-full bg-gradient-to-tr from-green-600 to-green-400 text-white" ></div>
                      </div>
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="py-3 px-5 border-b border-blue-gray-50">
                    <div class="w-10/12">
                      ...
                      <div class="flex flex-start bg-blue-gray-50 overflow-hidden w-full rounded-sm font-sans text-xs font-medium h-1">
                        <div class="flex justify-center items-center w-[25%] h-full bg-gradient-to-tr from-blue-600 to-blue-400 text-white"></div>
                      </div>
                    </div>
                  </td>
                </tr>
        ...
        <div className="w-full bg-base-200 h-96 min-w-[300px] rounded-xl">
            <div className="w-full bg-base-300 px-2 py-2 rounded-t-xl font-bold">
                <h2>Categories</h2>
            </div>
            <div>
                <ul className=" ">
