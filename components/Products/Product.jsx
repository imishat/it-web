...
function Product() {
    return (
        <section class="text-gray-700 container mx-auto body-font overflow-hidden  bg-white">
  <div class="container px-5 pt-24 max-h-fit  mx-auto">
    <div class="lg:w-4/5 mx-auto flex  flex-wrap">
      <Image width={900} height={900} alt="products" class="lg:w-1/2 w-full object-cover object-center  rounded border border-gray-200" src="https://www.whitmorerarebooks.com/pictures/medium/2465.jpg"/>
