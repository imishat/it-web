    ...
    return (
      ...
      <Link 
        ...
        >
          <div className="absolute left-0 bottom-0 w-full h-full z-10"
            ></div>
          <Image width={400} height={500} alt="" src="https://images.unsplash.com/photo-1493770348161-369560ae357d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2100&q=80" className="absolute left-0 top-0 w-full h-full rounded z-0 object-cover" />
        ...
        <a className="w-full md:w-1/3 relative rounded h-[24em]" 
          href={`/blog/12`}
        >
          <div className="absolute left-0 top-0 w-full h-full z-10"></div>
          <Image width={400} height={400} alt="" src="https://images.unsplash.com/photo-1543362906-acfc16c67564?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1301&q=80" className="absolute left-0 top-0 w-full h-full rounded z-0 object-cover" />
          <div className="p-4 absolute bottom-0 left-0 z-20">
      ...
      <div className="block lg:flex lg:space-x-2 px-2 lg:p-0 mt-10 mb-10">
        ...
        <div className="w-full lg:w-2/3">
          ...
          <Link className="block rounded w-full lg:flex mb-10"
            href={`/blog/12`}
          >
            <div 
              className="h-48 lg:w-48 flex-none bg-cover text-center   opacity-75 bg-[url('https://images.unsplash.com/photo-1512621776951-a57141f2eefd?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2100&q=80')]"
          ...
          <div className="rounded w-full lg:flex mb-10">
            <div className="h-48 lg:w-48 flex-none bg-cover text-center   opacity-75 bg-[url('https://images.unsplash.com/photo-1512621776951-a57141f2eefd?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2100&q=80')]"
               title="deit is very important">
            </div>
            <div className="bg-white rounded px-4 flex flex-col justify-between leading-normal">
              <div>
