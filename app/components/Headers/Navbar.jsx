"use client";
import { IoCloseCircleOutline, IoGrid, IoHome } from "react-icons/io5";
  ...
  <div className=" ">
    <div className="navbar px-3 container mx-auto h-[50px] min-h-[50px] py-0 bg-base-100 border-b">
        ...
        <div className="flex items-center">
          ...
          >
            ...
            <div className={`w-full`}>
              ...
              {/* Sign up btn */}
              <a className="btn w-32 !min-h-[40px] h-[40px] rounded bg-green-600 hover:bg-green-500 text-white px-6">
                Sign Up
              </a>
              {/* Nav for mobile */}
              <div className="flex my-6 justify-start w-full">
                <div className="w-full flex flex-col space-y-4">
                  <div className="flex w-full items-center gap-3">
                    ...
                    <Link onClick={()=>setShowNav(false)} className="w-full" href={"/login"}>
                      Sign In
                    </Link>
                  </div>
                  {/* ==== */}
      ...
      <Link href={"/blogs"} className="px-4 text-sm hidden lg:block py-2">
        ...
        <button onClick={()=>dispatch(showModal(!modal))} className="btn hidden !min-h-[40px] h-[40px] lg:flex rounded bg-green-600 hover:bg-green-500 text-white px-6">
        Sign In
        </button>
...
function CartSidebar({setShowSidebar,showSidebar}) {
  return (
     ...
     <div className="">
      {
        [...Array(12).keys()]?.map((cart,i)=>{
          return <div className="flex my-2 border-b gap-2 px-1 border-gray-400">
            <img className="w-12 h-12 rounded" src="https://cdn.kwork.com/files/category/collage/categories_first_level/en/t3/programming_guest.webp" alt="" />
            <div className="flex flex-col space-y-1">
              <h2 className="font-bold text-sm leading-4">PSD TO Html Convert PSD TO Html Convert</h2>
     ...
     <div className="flex items-center bg-green-100 text-green-600 py-2 hover:bg-green-200 cursor-pointer gap-3 font-bold sticky bottom-0 justify-center">
