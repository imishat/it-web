    ...
    return (
        <div className="flex container mx-auto justify-center w-full border-b bg-base-200">
            <div className="flex overflow-x-auto w-full md:mx-12 my-4 h-6 gap-5 justify-between items-center">
                ...
                <img className="h-full" src="https://cdn.kwork.com/images/index/partners/en/leroy-merlin.svg?ver=3" alt="" />
                <img className="h-full" src="https://cdn.kwork.com/images/index/partners/en/bp.svg?ver=3" alt="" />
                <img className="h-full" src="https://cdn.kwork.com/images/index/partners/en/philips.svg?ver=3" alt="" />
            </div>
        </div>
    );
}
