...
function Product({ product }) {
  ...
  //
  return (
    <div className="hover:shadow-xl duration-300 h-[230] border bg-base-200 w-full relative">
      <button
      ...
      >
        ...
        <div
          ...
          onMouseEnter={() => setShowNavigation(true)}
        >
          <ProductSlider setShowNavigation={setShowNavigation} product={product} images={images} showNavigation={showNavigation} />
          <div className="py-2 px-1">
          <Link className="inline-block " href={`/product/${product?.id}`}>
